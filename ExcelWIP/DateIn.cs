...
namespace ExcelWIP
{
    public class DateIn
    {
        ...
        public void SQLToExcel(string fileName, string connectionString, string queryIn, Excel.Application oExcel, Excel._Workbook oWorkBook)
        {
            /*-------------------------*/
            ...
            {
                using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(queryIn.ToString(), sqlConnection))
                {
            ...
            workSheet.get_Range("B1", "B1").ColumnWidth = 20;
            ...
            workSheet.get_Range("G1", "G1").ColumnWidth = 10;
