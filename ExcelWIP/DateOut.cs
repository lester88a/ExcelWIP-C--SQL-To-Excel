...
namespace ExcelWIP
{
    public class DateOut
    {
        ...
        public void SQLToExcel(string fileName, string connectionString, string queryOut, Excel.Application oExcel, Excel._Workbook oWorkBook)
        {
            /*-------------------------*/
            ...
            {
                using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(queryOut.ToString(), sqlConnection))
                {
            ...
            //set column header's font to bold
