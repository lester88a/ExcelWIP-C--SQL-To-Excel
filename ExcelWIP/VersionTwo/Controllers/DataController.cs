...
namespace ExcelWIP.Controllers
{
    public class DataController
    {
        ...
        public ObservableCollection<Repair> GetAllRepairData()
        {
            Connection connection = new Connection();
            string connectionString = connection.GetConnectionString();
            string query = connection.GetQueryAll();
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand(query, con))
                {
                    ...
                    var items = JsonConvert.DeserializeObject<ObservableCollection<Repair>>(JsonConvert.SerializeObject(rows));
