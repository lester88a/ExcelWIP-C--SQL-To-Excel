...
{
    public class PiovtTableForPriority
    {
        ...
        public void CreatePiovtTable(string fileName, string sheetName)
        {
            ...
            Excel.PivotCache pivotCache = workBook.PivotCaches().Create(Excel.XlPivotTableSourceType.xlDatabase, sheetName + "!A1:E5000");
            ...
            Excel.PivotField pageField2 = (Excel.PivotField)pivotTable.PivotFields("Warranty");
